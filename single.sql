...
admission_age
-- death period hospital in hours
, round((cast(extract(epoch from pat.dod - adm.admittime)/(60*60) as numeric)), 2) as death_period
...
, pa.dob, pa.dod, pa.hadm_id, pa.admittime, pa.dischtime, pa.admission_age, pa.death_period,
pa.los_hospital
...
-- select pa.subject_id
-- , pa.dob, pa.hadm_id, pa.admittime, pa.admission_age, pa.dischtime, pa.los_hospital
-- , ai.icustay_id, ai.intime, ai.wait_period, ai.include_adm, ai.include_icu
